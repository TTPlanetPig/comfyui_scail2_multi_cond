...
const SCAIL_WIDGET_TOOLTIPS = new Map([
    ...
    ["max_content_shift_px", "Maximum allowed integer-pixel content shift for generated reference pack images."],
    ["content_alignment_device", "Device used to estimate reference-pack content shift. auto prefers CUDA, then MPS, then CPU."],
